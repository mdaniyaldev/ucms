      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-slate-500 dark:text-slate-400">
            Manage, review, and resolve reported issues efficiently.
          </p>
        </div>
                        ...
                        <div className="flex items-center gap-4 pt-2">
                          <div className="flex items-center gap-2 text-xs text-slate-500 bg-slate-50 dark:bg-slate-900/50 py-1 px-2.5 rounded-full">
                            ...
                            <span className="font-medium text-slate-700 dark:text-slate-300">
                              {complaint.student?.role === 'faculty' ? 'Faculty ID: ' : 'Student ID: '}
                              {complaint.student?.unique_id || "Unknown"}
                            </span>
                          </div>
                          <Badge variant="outline" className={`text-xs ${complaint.priority === 'high' ? 'text-red-600 border-red-200 bg-red-50' :
      ...
      <Dialog open={commentOpen} onOpenChange={setCommentOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              This comment will be added to the complaint timeline and is visible to the submitter.
            </DialogDescription>
          </DialogHeader>
          <div className="py-2">
            <Textarea
