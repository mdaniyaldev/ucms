...
export function SubmitComplaintForm({ language = "en" }) {
  ...
  const text = {
    ...
    ur: {
      ...
      successDescription:
        "آپ کی شکایت رجسٹر ہو گئی ہے اور متعلقہ محکمے کو بھیج دی گئی ہے۔",
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="border-2 border-dashed border-gray-300 dark:border-slate-600 rounded-lg p-4 sm:p-8 text-center hover:border-blue-400 dark:hover:border-blue-500 transition-colors cursor-pointer bg-gray-50 dark:bg-slate-900/50">
